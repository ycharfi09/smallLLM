...
MODEL_VARIANTS = {
    "SmallCoder-Tiny": {
        ...
        "description": "Ultra-compact model (~100M params) for minimal hardware",
        "estimated_params_m": 100,
    ...
    "SmallCoder-Small": {
        ...
        "description": "Compact model (~194M params) for resource-constrained environments",
        "estimated_params_m": 194,
    ...
    "SmallCoder-Tiny-LC": {
        ...
        "description": "Long context variant of Tiny (~100M params) with 8K context",
        "estimated_params_m": 100,
    ...
    "SmallCoder-Small-LC": {
        ...
        "num_key_value_heads": 4,
        "max_position_embeddings": 8192,
        "description": "Long context variant of Small (~194M params) with 8K context",
        "estimated_params_m": 194,
